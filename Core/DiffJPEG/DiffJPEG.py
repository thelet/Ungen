...
# Local
from Core.DiffJPEG.modules import compress_jpeg, decompress_jpeg
from Core.DiffJPEG.utils import diff_round, quality_to_factor
...
class DiffJPEG(nn.Module):
    def __init__(self, height, width, differentiable=True, quality=80):
        ...
        '''
        print("Initialize the DiffJPEG layer")
